      ...
      {isSignupOpen && (
        ...
        >
          <motion.form
            ...
            className="bg-grey-tertiary border-grey-secondary relative m-3 flex w-130 flex-col gap-2.5 rounded-lg border-1 px-12 py-14"
          ...
          >
            ...
            />
            <Title level={1} className="text-grey-primary-light">
              Join list&watch
            </Title>
