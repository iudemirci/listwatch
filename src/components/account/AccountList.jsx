...
function AccountList({ currentList }) {
  ...
  return !isDeleting ? (
    <div className="flex flex-col gap-2">
      ...
      <ul className="grid grid-cols-3 gap-x-2 md:grid-cols-5 lg:grid-cols-6 2xl:grid-cols-7">
        {isItemsPending
...
//           </div>
//         </div>
//         <ul className="grid grid-cols-4 grid-rows-3 gap-1.5 sm:grid-cols-5 lg:gap-2 2xl:grid-cols-6">
